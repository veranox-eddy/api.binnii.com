...
/**
 * Country names for the address "Select country" dropdowns. ISO 3166-1
 * territories in English, collated for display; stored as the plain name
 * (children.country / staff.country are varchar(80)).
 */
class Countries
{
    ...
    public const array NAMES = [
        ...
        'Congo - Kinshasa', 'Cook Islands', 'Costa Rica', 'Côte d’Ivoire',
        ...
        'Guyana', 'Haiti', 'Heard & McDonald Islands', 'Honduras',
        ...
        'Samoa', 'San Marino', 'São Tomé & Príncipe', 'Sark',
        ...
        'Sudan', 'Suriname', 'Svalbard & Jan Mayen', 'Sweden',
        'Switzerland', 'Syria', 'Taiwan', 'Tajikistan',
        'Tanzania', 'Thailand', 'Timor-Leste', 'Togo',
        'Tokelau', 'Tonga', 'Trinidad & Tobago', 'Tunisia',
        'Türkiye', 'Turkmenistan', 'Turks & Caicos Islands', 'Tuvalu',
        'U.S. Outlying Islands', 'U.S. Virgin Islands', 'Uganda', 'Ukraine',
